...
<p style="font-size:10px;color:#9ca3af;margin-top:24px">Generated by CreditDecide &middot; ${s.evidence_count} evidence records attached</p>
</body></html>`;
...
export function downloadDecisionPdf(s) {
  ...
  const addFooter = () => {
    ...
    doc.text("CreditDecide  —  Underwriting Decision Summary", left, pageH - 28);
