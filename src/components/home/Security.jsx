    ...
    <section className="relative overflow-hidden border-b border-[#eceef1] dark:border-slate-800 bg-gradient-to-b from-[#fafbfc] to-white dark:from-slate-950 dark:to-slate-950">
      ...
      <div className="relative max-w-5xl mx-auto px-5 sm:px-8 py-16 sm:py-20">
        ...
        <div className="mt-10 grid sm:grid-cols-2 gap-3 max-w-3xl">
          {ITEMS.map((it, i) => (
            <div key={it} className="group flex items-center gap-3 rounded-xl border border-[#eceef1] dark:border-slate-800 bg-white dark:bg-slate-900 px-4 py-3.5 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md hover:border-[#0d9488]/30">
