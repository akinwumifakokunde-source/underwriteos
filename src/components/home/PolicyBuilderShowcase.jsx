        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="rounded-2xl border border-[#e8eaee] bg-white overflow-hidden shadow-[0_1px_2px_rgba(10,12,18,0.04),0_12px_40px_-12px_rgba(10,12,18,0.12)]">
            ...
            <div className="p-4 space-y-2.5">
              {RULES.map((r, i) => (
                <div key={i} className="flex items-center gap-2.5 rounded-xl border border-[#eceef1] bg-[#fafbfc] px-3.5 py-3 transition-colors hover:bg-white hover:border-[#d0d3d8]">
