  ...
  return (
    <section className="py-16 sm:py-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        {/* Tab bar */}
        <div className="rounded-2xl border border-slate-200 bg-[#f8f9fa] p-3 sm:p-4 shadow-sm">
            ...
            {STAGES.map((s, i) => {
              ...
              return (
                <div key={s.id} className="relative shrink-0">
                  ...
                  <div
                    className={`relative flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[13px] font-medium whitespace-nowrap transition-colors duration-300 ${
        ...
        {/* Stage description */}
        <div className="mt-6 min-h-[72px] flex items-start gap-3">
          <motion.div
            key={stage.id}
