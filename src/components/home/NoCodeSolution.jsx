...
export default function NoCodeSolution() {
  return (
    <section className="border-b border-[#eceef1] dark:border-slate-800">
      <div className="max-w-5xl mx-auto px-5 sm:px-8 py-20 sm:py-24">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-12 sm:mb-20">
          {PROBLEMS.map((p) => (
            <div key={p.num} className="rounded-2xl border border-[#eceef1] dark:border-slate-800 bg-gradient-to-b from-white to-[#fcfcfd] dark:from-slate-900 dark:to-slate-900 p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_18px_40px_-16px_rgba(10,12,18,0.14)]">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {SOLUTION_POINTS.map((s) => {
            const Icon = s.icon;
            return (
              <div key={s.title} className="group rounded-2xl border border-[#eceef1] dark:border-slate-800 bg-white dark:bg-slate-900 p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_18px_40px_-16px_rgba(13,148,136,0.25)] hover:border-[#0d9488]/30">
