  ...
  return (
    <section className="border-b border-[#eceef1] bg-white">
      <div className="max-w-5xl mx-auto px-5 sm:px-8 py-10">
        ...
        <div className="grid grid-cols-2 sm:flex sm:flex-wrap items-center justify-center gap-x-7 gap-y-3">
          {MARKETS.map((m) => (
            <div key={m.code} className="flex items-center gap-2 justify-center sm:justify-start">
