    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <FormField label="Annual income (£)" value={form.annual_income} onChange={(v) => set("annual_income", v)} type="number" extracted={isExtracted("annual_income")} />
        </div>
      </div>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          <FormSelect label="Loan product" value={form.product_type} onChange={(v) => set("product_type", v)} options={[
            { value: "personal_loan", label: "Personal Loan" },
            { value: "auto_loan", label: "Auto Loan" },
            { value: "business_loan", label: "Business Loan" },
            { value: "mortgage", label: "Mortgage" },
          ]} />
          <FormSelect label="Underwriting policy" value={form.policy_id} onChange={(v) => set("policy_id", v)} options={[
            { value: "consumer-v1", label: "Consumer Lending v1" },
            { value: "sme-v1", label: "SME Lending v1" },
          ]} />
          <FormField label="Requested amount (£)" value={form.loan_amount} onChange={(v) => set("loan_amount", v)} type="number" />
