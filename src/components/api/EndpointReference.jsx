...
const ENDPOINTS = [
  ...
  { group: "Profiles", items: [
    { method: "GET", path: "/v1/applications/{id}/financial-profile", desc: "Retrieve canonical financial profile" },
    { method: "GET", path: "/v1/applications/{id}/credit-profile", desc: "Retrieve normalized credit profile" },
  ]},
  { group: "Intelligence", items: [
    ...
    { method: "GET", path: "/v1/applications/{id}/evidence", desc: "Retrieve evidence graph" },
    { method: "GET", path: "/v1/applications/{id}/recommendation", desc: "Retrieve AI recommendation" },
    { method: "GET", path: "/v1/applications/{id}/decision", desc: "Retrieve final decision" },
